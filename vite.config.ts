 ...
 * It handles environment variables, server settings, plugin integration (React,
 * PWA),
 * and path aliases.
 *
 * @param {object} configEnv - The configuration environment object.
 * @param {string} configEnv.mode - The mode the app is running in (e.g.,
      ...
      rollupOptions: {
        output: {
          manualChunks: (id) => {
            ...
            if (id.includes('node_modules/lucide-react') || id.includes('node_modules/@headlessui/react')) return 'vendor-ui';
